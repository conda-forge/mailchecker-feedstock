...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mailchecker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11323&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mailchecker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mailchecker` can be installed with:

```
conda install mailchecker
```

It is possible to list all of the versions of `mailchecker` available on your platform with:
